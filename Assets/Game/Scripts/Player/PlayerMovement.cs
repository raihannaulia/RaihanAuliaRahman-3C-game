...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Sprint(bool isSprint)
    {
        if (isSprint)
        {
            ...
            {
                _speed = _speed + walkSprintTransition * Time.deltaTime;
            }
        }
        else
        {
    ...
    {
        bool isInFrontOfClimbingWall = Physics.Raycast(_climbDetector.position, transform.forward, out RaycastHit hit, _climbCheckDistance, 
                                                        _climbableLayer);
